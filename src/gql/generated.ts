...
export type CountryFragment = { __typename?: 'Country', name: string, emoji: string, phone: string, code: string };

export type GetCountriesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', name: string, emoji: string, phone: string, code: string }> };
